...
use PatchWork\Diff\Utility\Arr;
...
final class Differ
{
    ...
    /**
     * @var Sequence_Matcher the sequence matcher
     */
    ...
    {
        $this->sequenceMatcher = new Sequence_Matcher([], []);
    ...
    private function getGroupedOpcodesPre(array &$old, array &$new): void
    {
        ...
        static $eolAtEofHelperLines = [
            Sequence_Matcher::APPENDED_HELPER_LINE,
            Sequence_Matcher::APPENDED_HELPER_LINE,
            Sequence_Matcher::APPENDED_HELPER_LINE,
            Sequence_Matcher::APPENDED_HELPER_LINE,
        ];
    ...
    {
        // remove those extra lines cause by adding extra Sequence_Matcher::APPENDED_HELPER_LINE lines
